...
var floor2 = tryRequire( resolve( __dirname, './../lib/native.js' ) );
var opts = {
	'skip': ( floor2 instanceof Error )
};
...
tape( 'the function rounds a numeric value to the nearest power of two toward negative infinity', opts, function test( t ) {
