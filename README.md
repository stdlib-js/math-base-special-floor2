...
```javascript
floor2 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-floor2@v0.3.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-floor2@v0.3.1-umd/browser.js"></script>
```
